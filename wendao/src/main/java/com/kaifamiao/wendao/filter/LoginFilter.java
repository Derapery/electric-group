...
public class LoginFilter implements Filter {
    ...
    public void init(FilterConfig config) throws ServletException {
        urls = Set.of("/topic/thumbsState","/topic/publish","/topic/mine","/customer/settings","/customer/change", "/explain/thumbsState","/customer/fansAction","/explain/mine","/customer/mine");
    }
